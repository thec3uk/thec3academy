...
const Testimonial = ({ data }) => {
  return (
    <section className={"px-8 text-black lg:mx-8 lg:mt-32 lg:-mb-32"}>
      ...
      ></div>
      <div className={`grid lg:grid-cols-1 lg:grid-rows-${data.items.length} col-gap-px`}>
          ...
          return (
            ...
            >
              ...
              <div className="row-start-1 row-end-2 lg:row-span-1 lg:col-span-3 flex flex-col justify-center">
                <div className="pt-10 px-6 font-sans" dangerouslySetInnerHTML={{ __html: person.position.html }}></div>
