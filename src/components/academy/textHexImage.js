...
const TextWithHexImage = ({ data }) => {
  ...
  return (
    <section className={`lg:px-8 text-black ${bgColour} -my-16 lg:-my-32 py-32`}>
      <div
        className={
      ...
      >
        ...
        <div className="col-span-3 flex flex-col justify-center">
          ...
          ></div>
          <div className="pt-4 px-6 font-sans" dangerouslySetInnerHTML={{ __html: data.primary.text.html }}></div>
        </div>
        {!data.primary.image_reversed && (
